...
namespace Ttelo.Server.Migrations
{
    ...
    [Migration("20180601191217_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ttelo.Shared.Match", b =>
                {
            ...
            modelBuilder.Entity("Ttelo.Shared.Player", b =>
                {
            ...
            modelBuilder.Entity("Ttelo.Shared.Match", b =>
                {
                    b.HasOne("Ttelo.Shared.Player", "Loser")
                        .WithMany()
                        .HasForeignKey("LoserPlayerId");

                    b.HasOne("Ttelo.Shared.Player", "Winner")
                        .WithMany()
